...
def graph_win_and_loss_streaks(df1, title_color):
    ...
    # Define base chart with common encoding
    ...
    bars = base.mark_bar().properties(width=alt.Step(20))  # Control the width of each bar

    # Combine the bars and text
    chart = bars.facet(column='Streak:N')  # Facet by streak to group bars side by side
