...
train_dataset = CocoDetection(img_folder='data/images/table_detection_modeling_data/train', processor=processor)
val_dataset = CocoDetection(img_folder='data/images/table_detection_modeling_data/val', processor=processor, train=False)
...
checkpoint_callback = TransformersCheckpointCallback(
    save_path='tatr_model/best_model_detect',
